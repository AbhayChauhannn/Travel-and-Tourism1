...
public class ViewBookedHotel extends JFrame implements ActionListener {
    ...
    JButton back;
       ViewBookedHotel( String username)
       {
            ...
            lblgender.setBounds(30,340,150,25);
            add(lblgender);
            ...
            lbladdress.setBounds(30,420,150,25);
            add(lbladdress);
            ...
            Image i2= il.getImage().getScaledInstance(470, 400, Image.SCALE_DEFAULT);
            ImageIcon i3= new ImageIcon(i2);
            JLabel image =new JLabel(i3);
            image.setBounds(390, 50, 480, 380);
            add(image);
