               ...
               
       {
        ...
        add(labelprice);
           ...
           try{
            ...
            checkpackage= new JButton("Check Price");
            checkpackage.setBackground(Color.BLACK);
            checkpackage.setForeground(Color.WHITE);
            checkpackage.setBounds(60, 380, 120, 25);
            ...
            image.setBounds(500, 70, 400, 270);
            add(image);
        ...
        public void actionPerformed(ActionEvent ae){
            if(ae.getSource() == checkpackage)
            {
                ...
                {
                    cost+=12000;
                }else if(pack.equals("Silver Pacakge"))
            ...
            }else if(ae.getSource() == bookpackage)
            {
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Package Booked Successully");
                    setVisible(false);
                }catch(Exception e)
                {
                    e.printStackTrace();
