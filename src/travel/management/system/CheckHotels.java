...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run()
    {
        String[] text = new String[]{"JW Marriott Hotel", "Mardarin Oriental Hotel" , "Four Seasons Hotel", "Raddision Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel"};
        try{
   ...
   CheckHotels()
    {
        ...
        caption = new JLabel();
        caption.setBounds(65,410, 900, 70);
