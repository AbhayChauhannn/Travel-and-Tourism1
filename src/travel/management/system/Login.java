...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        password1.setBounds(60,110,100,25);
        password1.setFont(new Font("SAN SERIE", Font.PLAIN,20));
        p2.add(  password1);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource() == login)
        {
            try{
                ...
                String qurey ="select * from account where username = '"+username+"' AND password = '"+password+"'";
                Conn c = new Conn();
