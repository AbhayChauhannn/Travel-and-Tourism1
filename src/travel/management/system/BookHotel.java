               ...
               
       {
        ...
        add(labelprice);
           ...
           try{
            ...
            checkpackage.setBounds(60, 480, 120, 25);
            ...
            image.setBounds(500, 85, 400, 270);
            add(image);
        ...
        setVisible(true);
                ...
                else if(ae.getSource() == bookpackage)
            {
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Hotel Booked Successully");
                    setVisible(false);
                }catch(Exception e)
                {
                    e.printStackTrace();
